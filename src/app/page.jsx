...
import logoStarbucks from '@/images/logos/wo.a2b262ab.png'
import ssip from '@/images/logos/ssip.b61f5698.png'
import cne from '@/images/logos/CEALS_emblem_1200pxX385px-px70l72b9b4z00bd5f7hweoablsime8f5aotabehk0.png'
...
function Resume() {
  let resume = [
    ...
    {
      company: 'CE Publishing Inc',
      title: 'Interactive Media Dev',
      logo: cne,
      start: '2011',
      end: '2012',
    },         
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://www.linkedin.com/in/juan-carlos-eejay-de-borja-80696651/" variant="secondary" className="group mt-6 w-full">
        Request for CV Copy
